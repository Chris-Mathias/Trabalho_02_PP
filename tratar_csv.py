...
# 2. Verifica se a coluna 'text' existe no arquivo
if 'text' in df.columns:
    ...
    # Opcional: Se seu arquivo também tiver o caractere '\r' (comum em arquivos Windows)
    # você pode encadear as substituições:
